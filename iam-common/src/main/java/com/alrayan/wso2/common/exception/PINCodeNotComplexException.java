...
/**
 * Custom exception class to depict PIN validation complexity failure.
 *
 * @since 1.0.0
 */
public class PINCodeNotComplexException extends Exception {

    private static final long serialVersionUID = -1561608376565733643L;

    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause(Throwable)}.
     */
    public PINCodeNotComplexException() {
        super();
    }
     ...
     */
    public PINCodeNotComplexException(String message) {
        super(message);
    }
     ...
     */
    public PINCodeNotComplexException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the cause of the exception
     */
    public PINCodeNotComplexException(String message, Throwable cause) {
        super(message, cause);
    }
}
