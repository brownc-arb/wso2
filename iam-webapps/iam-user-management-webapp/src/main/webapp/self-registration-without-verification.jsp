...
<%@ page import="com.alrayan.wso2.webapp.management.serviceclient.UserRegistrationClient" %>
<%@ page import="javax.ws.rs.core.Response" %>
<%@ page import="com.google.gson.Gson" %>
<%@ page import="com.alrayan.wso2.webapp.management.serviceclient.beans.Claim" %>
