...
<%
    ...
    final String SERVICE_PROVIDER = "sp";
    String requestedClaims = null;
    String mandatoryClaims = null;
    String serviceProvider = null;
    String sessionDataKey = (String)request.getParameter("sessionDataKey");

    Map<String, Serializable> sensitiveDataMap = SensitiveDataRetriever.getSensitiveData(sessionDataKey,true);

    if ("false".equals(sensitiveDataMap.get(IS_ERROR))) {
        requestedClaims = (String)sensitiveDataMap.get(Constants.REQUESTED_CLAIMS);
        mandatoryClaims = (String)sensitiveDataMap.get(Constants.MANDATORY_CLAIMS);
        serviceProvider = (String)sensitiveDataMap.get(SERVICE_PROVIDER);
    } else {
    ...
    if (requestedClaims != null) {
        requestedClaimList = requestedClaims.split(Constants.CLAIM_SEPARATOR);
    }

    if (mandatoryClaims != null) {
        mandatoryClaimList = mandatoryClaims.split(Constants.CLAIM_SEPARATOR);
    }
%>
