...
<%
    ...
    final String SESSION_DATA_KEY_CONSENT = "sessionDataKeyConsent";
    final String ACCESS_TOKEN = "accessToken";
    final String DISPLAY_SCOPES = "displayScopes";

    String sessionDataKeyConsent = (String) request.getParameter(SESSION_DATA_KEY_CONSENT);
    ...
    Map<String, Serializable> sensitiveDataMap = SensitiveDataRetriever.getSensitiveDataWithConsentKey(sessionDataKeyConsent);
                ...
                <div class="row">
                        ...
                        <div class="brand-container add-margin-bottom-5x">
                            <div class="row">
                                ...
                                float-remove-xs pull-right-md pull-right-lg">
                                    <img src="images/wso2-open-banking-logo.png"
                                            ...
                                            <table width="100%" class="styledLeft margin-top-double">
                                                ...
                                                <tr>
                                                    <td class="buttonRow" colspan="2">
                                                        <input type="hidden"
                                                               name="<%=Constants.SESSION_DATA_KEY_CONSENT%>"
                                                               value="<%=Encode.forHtmlAttribute(sessionDataKeyConsent)%>"/>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 data-container">
                        ...
                        <%
                            ...
                            Map<String, Object> paymentDataSet = apiDataRetriever.getPaymentDataSet(requestObject,appName);
                        ...
                        <form action="oauth2_authz_confirm.do" method="post" id="oauth2_authz_confirm"
                            ...
                            <div class="login-form">
                                ...
                                <% if(paymentDataSet.containsKey("debtor_account")){
                                    DebtorAccount da = (DebtorAccount)paymentDataSet.get("debtor_account");
                                ...
                                <div class="form-group">
                                    ...
                                    <select <%= StringUtils.isNotBlank(selectedAccount) ? "disabled" : "" %>
                                            class="form-control" id="payaccselect" onchange="updatePaymentAcc(this)">
                                        ...
                                        <%
                                            ...
                                            for (int i = 0; i < payableAccountsArray.length(); i++) {
                                                ...
                                                String account_id = object.getString("account_id");
                                            ...
                                            <%
                                                ...
                                                for (String selectedAccount : reauthSelectedAccounts) {
                                                    for (int i = 0; i < sharableAccountsArray.length(); i++) {
                                                        ...
                                                        String account_id = accountObject.getString("account_id");
                                                        String display_name = accountObject.getString("display_name");
                    ...
                    <%
                        ...
                        if (scopeArray != null && scopeArray.length > 0 &&
                            ...
                            APIDataRetriever apiDataRetriever = APIDataRetriever.getApiDataRetriever();
                            Map<String, Object> paymentDataSet = apiDataRetriever.getPaymentDataSet(requestdata,appName);
                            String paymentInitiationData;
                            if ("false".equals(paymentDataSet.get(IS_ERROR))) {
                                paymentInitiationData = (String) paymentDataSet.get("paymentInitiationData");
                            } else {
